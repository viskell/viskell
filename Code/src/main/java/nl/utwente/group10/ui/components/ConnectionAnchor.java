...
public abstract class ConnectionAnchor extends Circle implements Initializable {
	...
	/**
	 * @return The newly made Connection if successful. Note that failing to add
	 *         a connection while already connected will still return an empty
	 *         optional. (No new Connection was created)
	 */
	public abstract Optional<Connection> createConnectionWith(
			ConnectionAnchor other);
