...
/**
 * This class represents a connection between two different FunctionBlocks.
 * The output of one FunctionBlock will be used as input for another FunctionBlock
 */
public class Connection extends StackPane{
	 ...
	 * @throws IOException
	 */
	public static Connection newInstance(FunctionBlock in, FunctionBlock out, int outarg) throws IOException{
		//TODO instantiate XML instead of blank new connection
	...
	//Private method to set the functionBlock where the input will be directed to
	//AKA the output
