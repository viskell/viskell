...
The CircleMenu class, an extension of the CirclePopupMenu of the JFXtras library, fulfils this role by spawning a series of icons that trigger context specific actions such as: copy, paste, save and delete.
As of this writing delete is the only context specific actions that has been implemented.
